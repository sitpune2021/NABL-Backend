...
class Instrument extends Model
{
    ...
    */
    ...
    // Lab override → Master instrument
    public function parent()
    {
        return $this->belongsTo(Instrument::class, 'parent_id');
    }

    // Master instrument → Lab overrides
    ...
    public function lab()
    {
        return $this->hasOneThrough(
            ...
            'parent_id', // master instrument
            'owner_id'   // lab instrument
        )->where('instruments.owner_type', 'lab')
    ...
    */
    ...
    {
        return $this->hasOne(Instrument::class, 'parent_id')
